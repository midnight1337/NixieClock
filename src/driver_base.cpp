...
DriverBase::DriverBase(int pin_a, int pin_b, int pin_c, int pin_d) : m_pin_a(pin_a), m_pin_b(pin_b), m_pin_c(pin_c), m_pin_d(pin_d) {}
...
void DriverBase::truth_table()
{
    // ... Match input to output, return as 4 bit bitset
}
